...
def casemodul(p,q):
    ...
    for k in range(0,ppc["bus"].shape[0]):
        ppc["bus"][k,2]= p[k] #reset the p value 
        ppc["bus"][k,3]= q[k] #reset the q value
    ...
    ppc["branch"][:,2]= (0.494 * 0.1 / 1.1) * ones(24)
    ppc["branch"][:,3]= (0.0883 * 0.1 / 1.1) * ones(24)
